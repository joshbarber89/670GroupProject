...
public class AddFoodActivityTest {
    ...
    private AddFoodHelper addFoodHelper;

    @Before
    public void setUp() {
        mockDB = mock(DBHelper.class);
        addFoodHelper = new AddFoodHelper();
        addFoodHelper.DB = mockDB;
    }
    ...
    public void testInsert_ValidInput() {
        ...
        assertTrue(addFoodHelper.insert(day, month, year, hour, minute, value, amPMValue));

        // Verify that the correct insertEntry method is called with the right parameters
        verify(mockDB, times(1)).insertEntry("foodTable", value, day, month, year, hour, minute, amPMValue);
    }
    ...
    public void testInsert_InvalidInput() {
        ...
        assertFalse(addFoodHelper.insert(day, month, year, hour, minute, value, amPMValue));
    ...
    public void testDatetimeModification_SingleDigit() {
        ...
        String result = addFoodHelper.datetimeModification(value);
