...
public class InvalidRegistration {
    ...
    public void invalidRegistration() {
        ...
        String emailAddress = getRandomAlphabetString() + "@domain.com";
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.registerActivityEmailAddress),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText.perform(replaceText(emailAddress), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.registerActivityEmailAddress),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText(emailAddress), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.registerActivityRePassword),
                        childAtPosition(
                                ...
                                5),
                        isDisplayed()));
        appCompatEditText6.perform(replaceText("pass123"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withText("Enter Email Address"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView.check(matches(isDisplayed()));

        ViewInteraction textView2 = onView(
                allOf(withText("Enter Password"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView2.check(matches(isDisplayed()));

        ViewInteraction textView3 = onView(
                allOf(withText("Re Enter Password"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
