...
public class ValidRegistrationLoginAddUpdateDeleteMedication {
    ...
    @Test
    public void validRegistrationLoginAddUpdateDeleteMedication() {
        ...
        ViewInteraction materialButton4 = onView(
                allOf(withId(R.id.medicationButton), withText("Medication"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.medicationReading),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        2),
                                0),
                        isDisplayed()));
        appCompatEditText6.perform(replaceText("Medication: 500mg"), closeSoftKeyboard());

        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.medicationReading), withText("Medication: 500mg"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        2),
        ...
        ViewInteraction materialButton6 = onView(
                allOf(withId(R.id.submitmedicationButton), withText("Add New Entry"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        3),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.entryValue), withText("Medication: 500mg"),
                        withParent(withParent(withId(R.id.medicationList))),
                        isDisplayed()));
        textView.check(matches(isDisplayed()));

        DataInteraction linearLayout = onData(anything())
                .inAdapterView(allOf(withId(R.id.medicationList),
                        childAtPosition(
        ...
        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.medicationReading), withText("Medication: 500mg"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText8.perform(replaceText("Medication: 1000mg"));

        ViewInteraction appCompatEditText9 = onView(
                allOf(withId(R.id.medicationReading), withText("Medication: 1000mg"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        2),
        ...
        ViewInteraction materialButton7 = onView(
                allOf(withId(R.id.updatemedicationButton), withText("Update Entry"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        3),
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.entryValue), withText("Medication: 1000mg"),
                        withParent(withParent(withId(R.id.medicationList))),
                        isDisplayed()));
        ...
        ViewInteraction materialButton8 = onView(
                allOf(withId(R.id.deletemedicationButton), withText("Delete Entry"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        3),
