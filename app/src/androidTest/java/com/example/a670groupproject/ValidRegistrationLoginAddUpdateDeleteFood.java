...
public class ValidRegistrationLoginAddUpdateDeleteFood {
    ...
    @Test
    public void validRegistrationLoginAddUpdateDeleteFood() {
        ...
        ViewInteraction materialButton4 = onView(
                allOf(withId(R.id.foodButton), withText("Food"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.foodReading),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText6.perform(replaceText("Rice with chicken"), closeSoftKeyboard());

        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.foodReading), withText("Rice with chicken"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        2),
        ...
        ViewInteraction materialButton6 = onView(
                allOf(withId(R.id.submitfoodButton), withText("Add New Entry"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        3),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.entryValue), withText("Rice with chicken"),
                        withParent(withParent(withId(R.id.foodList))),
                        isDisplayed()));
        textView.check(matches(isDisplayed()));

        DataInteraction linearLayout = onData(anything())
                .inAdapterView(allOf(withId(R.id.foodList),
                        childAtPosition(
        ...
        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.foodReading), withText("Rice with chicken"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText8.perform(replaceText("Apple pie"));

        ViewInteraction appCompatEditText9 = onView(
                allOf(withId(R.id.foodReading), withText("Apple pie"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        2),
        ...
        ViewInteraction materialButton7 = onView(
                allOf(withId(R.id.updatefoodButton), withText("Update Entry"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        3),
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.entryValue), withText("Apple pie"),
                        withParent(withParent(withId(R.id.foodList))),
                        isDisplayed()));
        ...
        ViewInteraction materialButton8 = onView(
                allOf(withId(R.id.deletefoodButton), withText("Delete Entry"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        3),
