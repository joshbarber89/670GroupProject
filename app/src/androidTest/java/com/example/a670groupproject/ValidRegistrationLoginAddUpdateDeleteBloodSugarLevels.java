...
public class ValidRegistrationLoginAddUpdateDeleteBloodSugarLevels {
    ...
    @Test
    public void validRegistrationLoginAddUpdateDeleteBloodSugarLevels() {
        ...
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.bloodSugarReading), withText("12"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        2),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.entryValue), withText("Blood Sugar:12"),
        ...
        ViewInteraction appCompatEditText9 = onView(
                allOf(withId(R.id.bloodSugarReading), withText("10"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        2),
        ...
        ViewInteraction materialButton7 = onView(
                allOf(withId(R.id.updateBloodSugarButton), withText("Update Entry"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        3),
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.entryValue), withText("Blood Sugar:10"),
                        withParent(withParent(withId(R.id.bloodSugarList))),
                        isDisplayed()));
